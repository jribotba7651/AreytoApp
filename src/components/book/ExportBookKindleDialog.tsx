...
interface ExportBookKindleDialogProps {
  onClose: () => void;
...
function ExportBookKindleDialog({ onClose, onExport, loading }: ExportBookKindleDialogProps) {
  ...
  return (
    ...
    >
      <div className="bg-bg-tertiary border border-border-default rounded-lg p-6 w-full max-w-md mx-4">
        <h2 className="text-base font-medium text-text-primary mb-1">Exportar a Kindle</h2>
        <p className="text-sm text-text-secondary mb-4">
          Elige qué capítulos incluir en el archivo para Kindle. Se exportará como EPUB optimizado.
        </p>
...
export default ExportBookKindleDialog;
