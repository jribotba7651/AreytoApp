...
interface ProjectState {
  ...
  updateProjectMeta: (updates: Partial<Pick<Project, 'capituloActivo' | 'tema' | 'temaOverrides' | 'bookSettings' | 'excludedFromExport' | 'chapterColors' | 'chapterTags' | 'chapterWordGoals' | 'bookmarks' | 'lastExportTimestamps'>>) => Promise<void>;
}
